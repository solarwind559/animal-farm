...
export default function FarmDetail({ auth }) {
    const { farm, flash, errors = {} } = usePage().props;
                        ...
                        <tbody>
                            {farm.animals.map((animal) => (
                                <tr key={animal.id} className="border-b border-gray-300">
                                    ...
                                    <td className="border border-gray-300 px-4 py-2 text-gray-800">{animal.years} years</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
